...
if(isset($_GET['order_id'])){
  ...
  if($stmt->execute()){
    header('location: dashboard.php?order_updated=Order updates successfully');
              ...
              <?php foreach($order as $r){ ?>
                ...
                <div class="form-group my-3">
                    ...
                    <select  class="form-select" required name="order_status">
                        ...
                        <option value="cancelled" <?php if($r['order_status']=='cancelled'){ echo "selected";}?>>Cancelled</option>
                    </select>
                </div>
